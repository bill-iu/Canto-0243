"""Land syn_len4 batch-6: accepted pairs + no_natural + adequate_existing."""
...
HEADS = FIXTURES / "syn_len4_b06_heads.tsv"
ACC_FIX = FIXTURES / "syn_len4_b06_accepted.tsv"
NN_FIX = FIXTURES / "syn_len4_b06_no_natural.tsv"
ADQ_FIX = FIXTURES / "syn_len4_b06_adequate.tsv"
...
def main() -> int:
    ...
    meta["batches"][BATCH] = {
        ...
        "model_note": (
            "syn_len4 b06 maintainer-curated blind-style pairs; "
