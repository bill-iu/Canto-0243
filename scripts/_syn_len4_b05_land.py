"""Land syn_len4 batch-5: accepted pairs + no_natural + adequate_existing."""
...
HEADS = FIXTURES / "syn_len4_b05_heads.tsv"
ACC_FIX = FIXTURES / "syn_len4_b05_accepted.tsv"
NN_FIX = FIXTURES / "syn_len4_b05_no_natural.tsv"
ADQ_FIX = FIXTURES / "syn_len4_b05_adequate.tsv"
...
def main() -> int:
    ...
    meta["batches"][BATCH] = {
        ...
        "model_note": (
            "syn_len4 b05 maintainer-curated blind-style pairs; "
