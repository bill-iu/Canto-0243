"""Land syn_top5000 batch-4: accepted pairs + no_natural + adequate_existing."""
...
HEADS = FIXTURES / "syn_top5000_b04_heads.tsv"
ACC_FIX = FIXTURES / "syn_top5000_b04_accepted.tsv"
NN_FIX = FIXTURES / "syn_top5000_b04_no_natural.tsv"
ADQ_FIX = FIXTURES / "syn_top5000_b04_adequate.tsv"
...
def main() -> int:
    ...
    meta["batches"][BATCH] = {
        ...
        "model_note": (
            "syn_top5000 b04 maintainer-curated blind-style pairs; "
