"""Land len4-b03: two-phase sample-parent commit then fail removal.
...
BATCH = "len4-b03-20260715"
SAMPLE_SEED = 20260718
PROMPT = ROOT / "data/syn_ant/project-antonyms-prompt-len4.txt"
HEADS = ROOT / "data/syn_ant/fixtures/len4_b03_unresolved.txt"
PARENT_FIXTURE = ROOT / "data/syn_ant/fixtures/len4_b03_parent_pairs.tsv"
NN_FIXTURE = ROOT / "data/syn_ant/fixtures/len4_b03_no_natural_final.tsv"
...
def _build_meta(
    *,
    ...
    return {
        ...
        "model_note": (
            "len4-b03 blind draft (maintainer-curated pairs + no_natural for opaque "
            "heads); A–D sample seed=20260718; soft-prefer 4-char tails"
        ),
        "model": "xai/grok-4",
        "model_provider": "xAI",
