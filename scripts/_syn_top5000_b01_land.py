"""Land syn_top5000 batch-1: accepted pairs + no_natural + adequate_existing."""
...
BATCH = "syn-top5000-b01-20260718"
SAMPLE_SEED = 20260718
FIXTURES = ROOT / "data" / "syn_ant" / "project" / "fixtures"
HEADS = FIXTURES / "syn_top5000_b01_heads.tsv"
ACC_FIX = FIXTURES / "syn_top5000_b01_accepted.tsv"
NN_FIX = FIXTURES / "syn_top5000_b01_no_natural.tsv"
ADQ_FIX = FIXTURES / "syn_top5000_b01_adequate.tsv"

# Maintainer A–D: weak / borderline pairs removed from final accept
SAMPLE_FAILS = [
    ("人類", "人"),  # hypernym-ish
    ("環境", "境況"),  # related, not stable near-syn
]
...
def main() -> int:
    ...
    meta["batches"][BATCH] = {
        ...
        "model_note": (
            "syn_top5000 b01 maintainer-curated blind-style pairs; "
