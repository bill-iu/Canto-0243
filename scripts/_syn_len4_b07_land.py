"""Land syn_len4 batch-7: accepted pairs + no_natural + adequate_existing."""
...
HEADS = FIXTURES / "syn_len4_b07_heads.tsv"
ACC_FIX = FIXTURES / "syn_len4_b07_accepted.tsv"
NN_FIX = FIXTURES / "syn_len4_b07_no_natural.tsv"
ADQ_FIX = FIXTURES / "syn_len4_b07_adequate.tsv"
...
def main() -> int:
    ...
    meta["batches"][BATCH] = {
        ...
        "model_note": (
            "syn_len4 b07 maintainer-curated blind-style pairs; "
