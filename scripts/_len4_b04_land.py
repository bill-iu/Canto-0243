"""Land len4-b04: two-phase sample-parent commit then fail removal.
...
BATCH = "len4-b04-20260715"
SAMPLE_SEED = 20260719
PROMPT = ROOT / "data/syn_ant/project-antonyms-prompt-len4.txt"
HEADS = ROOT / "data/syn_ant/fixtures/len4_b04_unresolved.txt"
PARENT_FIXTURE = ROOT / "data/syn_ant/fixtures/len4_b04_parent_pairs.tsv"
NN_FIXTURE = ROOT / "data/syn_ant/fixtures/len4_b04_no_natural_final.tsv"
...
def _build_meta(
    *,
    ...
    return {
        ...
        "model_note": (
            "len4-b04 blind draft (maintainer-curated pairs + no_natural for opaque "
            "heads); A–D sample seed=20260719; soft-prefer 4-char tails"
        ),
        "model": "xai/grok-4",
        "model_provider": "xAI",
