"""Land syn_len4 batch-3: accepted pairs + no_natural + adequate_existing."""
...
HEADS = FIXTURES / "syn_len4_b03_heads.tsv"
ACC_FIX = FIXTURES / "syn_len4_b03_accepted.tsv"
NN_FIX = FIXTURES / "syn_len4_b03_no_natural.tsv"
ADQ_FIX = FIXTURES / "syn_len4_b03_adequate.tsv"
...
def main() -> int:
    ...
    meta["batches"][BATCH] = {
        ...
        "model_note": (
            "syn_len4 b03 maintainer-curated blind-style pairs; "
