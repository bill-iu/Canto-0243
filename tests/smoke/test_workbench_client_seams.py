...
class WorkbenchClientSeamTests(unittest.TestCase):
    ...
    def test_phase1_closeout_guards(self) -> None:
        ...
        self.assertIn("candidate-scroll", cards)
        self.assertIn("scrollResetKey", cards)
        self.assertIn("scrollTop = 0", cards)
        self.assertIn("candidateScrollResetKey", page)
        self.assertIn("scrollResetKey={candidateScrollResetKey}", page)
    ...
    def test_compact_entry_flow_is_shared_by_query_and_workbench(self) -> None:
        ...
        self.assertIn("max-block-size: min(60dvh, 36rem)", workbench_css)
        self.assertIn("max-block-size: 52dvh", workbench_css)
        self.assertIn("overflow-y: auto", workbench_css)
        self.assertIn("scrollbar-width: none", workbench_css)
        self.assertIn("-ms-overflow-style: none", workbench_css)
        self.assertIn(".candidate-scroll::-webkit-scrollbar", workbench_css)
        self.assertNotIn(".candidate-scroll { overscroll-behavior", workbench_css)
