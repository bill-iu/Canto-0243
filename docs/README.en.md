...
<!-- words-count:en -->
Current word entries: **125,245** (`lyrics.db` · `words` table)
<!-- /words-count:en -->
...
1. Download **`canto-0243-portable.zip`** and **`canto-0243-portable-macos-x86_64.tar.gz`** from [GitHub Releases](https://github.com/bill-iu/Canto-0243/releases) (pin to [`Canto-0243 v1.0.3`](https://github.com/bill-iu/Canto-0243/releases/tag/v1.0.3)).
