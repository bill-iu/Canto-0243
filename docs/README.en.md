...
<!-- words-count:en -->
Current word entries: **193,280** (`lyrics.db` · `words` table)
<!-- /words-count:en -->

Official offline data bundle: **[Canto-0243 v1.5.0](https://github.com/bill-iu/Canto-0243/releases/tag/v1.5.0)** (`canto-0243-portable.zip`, macOS `tar.gz`, `lyrics.db`, `words-lexicon.json`). Feedback welcome on [GitHub Issues](https://github.com/ICE-U-code/Canto-0243/issues).
...
1. Download **`canto-0243-portable.zip`** from [GitHub Releases](https://github.com/ICE-U-code/Canto-0243/releases) (pin to [`Canto-0243 v1.5.0`](https://github.com/bill-iu/Canto-0243/releases/tag/v1.5.0)).
...
**Last updated**: 2026-06-17 (v1.5.0 · star anchors · guide refresh · unified startup · Jyutping copy)
