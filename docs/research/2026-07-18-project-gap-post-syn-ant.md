...
| 項目 | 內容 |
|------|------|
| batch_id | `post-syn-ant-b05-20260718` |
| b04 後殘餘 open | **38** |
| 入帳 ant | **23** 對 |
| no_natural | **25** 頭（名詞／無穩定反義） |
| validate | pairs **6313** ok |
| **b05 後 open** | **0**（Top-5k content 清零） |

代表：`勤力–懶惰`、`清靜–嘈`、`晨早–夜晚`、`有型–老土`、`唔覺意–特登`、`最愛–討厭`、`做得–做唔到`…

## 10. 累計 b01–b05（Top-5k post-syn 收官）
...
Essay Top-5k content「有近無反」：**~558 → 0**。

## 11. 下一步

1. **rebuild** `lyrics.db`／Release 關係令 runtime 見到新邊。  
2. 可選轉向 **Essay 5k–10k** ring（P1）。  
3. 勿開 UD。
