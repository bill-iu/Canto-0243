...
python scripts/fetch/fetch_essay_data.py     # 排序語料 → data/essay/essay-cantonese.txt（選用但建議）
python main.py
```
...
PG 相關 issue／PR 可 **best-effort** 合併小修，但不構成產品承諾。領域用語見 [`CONTEXT.md`](CONTEXT.md) § 交付形態。
