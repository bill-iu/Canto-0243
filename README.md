...
> **Essay 排序語料**已隨 repo 提供：`data/essay/essay-cantonese.txt`（來源：[rime-cantonese](https://github.com/rime/rime-cantonese)，[CC BY 4.0](https://github.com/rime/rime-cantonese/blob/main/LICENSE-CC-BY)）。若要更新至上游最新版：`python scripts/fetch/fetch_essay_data.py`
...
再分發或商用前請自行核對各上游原文。收錄與排序政策見 [`CONTEXT.md`](CONTEXT.md) § 詞庫與排序。
...
python scripts/fetch/fetch_essay_data.py [--verify]   # 可選：更新 essay 至上游最新
