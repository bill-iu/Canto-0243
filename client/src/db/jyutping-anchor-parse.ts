/**
 * Jyutping anchor parsing — port of app/services/jyutping_anchor_parse.py
 */
import {
...
export const AMBIGUOUS_PHONEME_LETTERS = new Set(['m', 'ng']);
export const INITIAL_CLUSTERS = new Set(['ng', 'gw', 'kw']);
...
/** Port of jyutping_anchor_parse.parse_jyutping_anchor_query */
...
export { normalizeRhymeLetters, rhymeLettersResolveOk };
