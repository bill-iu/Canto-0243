...
interface Props {
  ...
  finalAnchorDisabled: boolean;
  initialAnchorDisabled: boolean;
  ...
  return (
    <section className="constraint-bar" aria-labelledby="constraintHeading">
      ...
      <div className="anchor-actions" aria-label="讀音錨點">
        <button type="button" disabled={finalAnchorDisabled} onClick={onAddFinalAnchor}>末格同韻</button>
        <button type="button" disabled={initialAnchorDisabled} onClick={onAddInitialAnchor}>首格同聲</button>
      </div>
