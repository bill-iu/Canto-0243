    ...
    >
      <defs>
        ...
        <symbol id="brand-ink-flicks-dark" viewBox="0 0 200 72" overflow="visible">
          ...
          <path d="M132.2 48.4 L133.6 49.2" stroke="#FB7185" strokeWidth="0.65" strokeLinecap="round" opacity="0.55" />
          <path d="M134.2 46.2 L135.2 44.9" stroke="#FB7185" strokeWidth="0.5" strokeLinecap="round" opacity="0.45" />
          <path d="M132.8 47.6 L134.0 48.4" stroke="#FB7185" strokeWidth="0.4" strokeLinecap="round" opacity="0.38" />
          <path d="M134.0 46.6 L135.0 45.8" stroke="#FB7185" strokeWidth="0.3" strokeLinecap="round" opacity="0.32" />
        </symbol>
      </defs>
    </svg>
  );
