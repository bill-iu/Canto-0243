...
const GUIDE_QUICK_ROWS: GuideQuickRow[] = [
  ...
  },
  {
    ...
    examples: [
      ...
      { query: '23@手', mode: '0243', labelZh: '寫死尾字', labelEn: 'Lock last character' },
  ...
  },
  {
    ...
    blurbZh: '唔知嘅位留空；可以混聲調數字同寫死嘅漢字。',
    blurbEn: 'Leave unknowns open; mix tone digits with fixed characters.',
    examples: [
      { query: '+香??', mode: '0243', labelZh: '頭字寫死，其餘留空', labelEn: 'Lock first; leave rest open' },
...
const GUIDE_QUICK_WIDE_COLUMNS: GuideQuickWideColumn[] = [
  {
    rows: [
      ...
      {
        keys: ['='],
        titleZh: '數字＋參考字：同韻／同聲',
        titleEn: 'Digits + reference: rhyme / initial',
        blurbZh: '連續打數字＝每個字一個聲調；字後加 = 就同韻。',
        blurbEn: 'Digits in a row = one tone each; char= means same rhyme.',
        examples: [
          { query: '23就=', mode: '0243', labelZh: '二字：尾字同韻', labelEn: 'Two chars: last rhymes' },
