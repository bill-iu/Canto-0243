...
const GUIDE_QUICK_ROWS: GuideQuickRow[] = [
  ...
  },
  {
    ...
    blurbZh: '同韻／同聲（=）、用 + 加長（? 後通常可省）、@ 定實某個字、$ 疊字。',
    blurbEn: 'Rhyme/initial (=), + to lengthen (often skip after ?), @ lock a character, $ reduplication.',
    examples: [
      { query: '香=', mode: '0243', labelZh: '同韻', labelEn: 'Same rhyme' },
      { query: '23+好=', mode: '0243', labelZh: '用 + 加長同韻', labelEn: 'Lengthen with +' },
      { query: '?香=', mode: '0243', labelZh: '任意＋同韻', labelEn: 'Any + rhyme' },
...
const GUIDE_QUICK_WIDE_COLUMNS: GuideQuickWideColumn[] = [
  {
    rows: [
      ...
      },
      {
        ...
        titleZh: '同韻／同聲／加長',
        titleEn: 'Rhyme / initial / lengthen',
        blurbZh: '同韻／同聲（=）、用 + 加長（? 後通常可省）、@ 定實某個字。',
        blurbEn: 'Rhyme/initial (=), + to lengthen (often skip after ?), @ to lock a character.',
        examples: [
          { query: '香=', mode: '0243', labelZh: '同韻', labelEn: 'Same rhyme' },
          { query: '23+好=', mode: '0243', labelZh: '用 + 加長同韻', labelEn: 'Lengthen with +' },
          { query: '?香=', mode: '0243', labelZh: '任意＋同韻', labelEn: 'Any + rhyme' },
