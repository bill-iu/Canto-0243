/** ponytail: MF-5 F1 — code_digit / literal_char / wildcard filter parity vs executors */
...
if (!fs.existsSync(fixture)) {
  throw new Error(`position-match-filters-f1-self-check: missing ${fixture}`);
}
