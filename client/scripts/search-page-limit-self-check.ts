/**
 * First-page 400 / max 800 + cancel helpers.
...
assert.equal(SEARCH_PAGE_SIZE, 800);
...
assert.equal(searchLimitForOffset('0243', 400), 800);
assert.equal(searchLimitForOffset('synonym', 0), 400);
assert.equal(searchPageSizeForMode('0243'), 800);
