"""Land syn_top5000 batch-2: accepted pairs + no_natural + adequate_existing."""
...
HEADS = FIXTURES / "syn_top5000_b02_heads.tsv"
ACC_FIX = FIXTURES / "syn_top5000_b02_accepted.tsv"
NN_FIX = FIXTURES / "syn_top5000_b02_no_natural.tsv"
ADQ_FIX = FIXTURES / "syn_top5000_b02_adequate.tsv"

# Maintainer A–D: weak / borderline pairs removed from final accept
SAMPLE_FAILS = [
    ("百", "佰"),  # should not be accepted; safety
    ("地圖", "圖紙"),  # weak
]
...
def main() -> int:
    ...
    meta["batches"][BATCH] = {
        ...
        "model_note": (
            "syn_top5000 b02 maintainer-curated blind-style pairs; "
