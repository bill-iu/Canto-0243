"""Land syn_len4 batch-10: accepted pairs + no_natural + adequate_existing."""
...
HEADS = FIXTURES / "syn_len4_b10_heads.tsv"
ACC_FIX = FIXTURES / "syn_len4_b10_accepted.tsv"
NN_FIX = FIXTURES / "syn_len4_b10_no_natural.tsv"
ADQ_FIX = FIXTURES / "syn_len4_b10_adequate.tsv"
...
def main() -> int:
    ...
    meta["batches"][BATCH] = {
        ...
        "model_note": (
            "syn_len4 b10 maintainer-curated blind-style pairs; "
