"""Land len4-b02: two-phase sample-parent commit then fail removal.
...
BATCH = "len4-b02-20260715"
SAMPLE_SEED = 20260717
PROMPT = ROOT / "data/syn_ant/project-antonyms-prompt-len4.txt"
HEADS = ROOT / "data/syn_ant/fixtures/len4_b02_unresolved.txt"
PARENT_FIXTURE = ROOT / "data/syn_ant/fixtures/len4_b02_parent_pairs.tsv"
NN_FIXTURE = ROOT / "data/syn_ant/fixtures/len4_b02_no_natural_final.tsv"
...
def _build_meta(
    *,
    ...
    return {
        ...
        "model_note": (
            "len4-b02 blind draft (maintainer-curated pairs + no_natural for opaque "
            "heads); A–D sample seed=20260717; soft-prefer 4-char tails"
        ),
        "model": "xai/grok-4",
        "model_provider": "xAI",
