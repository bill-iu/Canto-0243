"""Land syn_len4 batch-8: accepted pairs + no_natural + adequate_existing."""
...
HEADS = FIXTURES / "syn_len4_b08_heads.tsv"
ACC_FIX = FIXTURES / "syn_len4_b08_accepted.tsv"
NN_FIX = FIXTURES / "syn_len4_b08_no_natural.tsv"
ADQ_FIX = FIXTURES / "syn_len4_b08_adequate.tsv"
...
def main() -> int:
    ...
    meta["batches"][BATCH] = {
        ...
        "model_note": (
            "syn_len4 b08 maintainer-curated blind-style pairs; "
