"""Land syn_len4 batch-1: accepted pairs + no_natural + adequate_existing."""
...
HEADS = FIXTURES / "syn_len4_b01_heads.tsv"
ACC_FIX = FIXTURES / "syn_len4_b01_accepted.tsv"
NN_FIX = FIXTURES / "syn_len4_b01_no_natural.tsv"
ADQ_FIX = FIXTURES / "syn_len4_b01_adequate.tsv"
...
def main() -> int:
    ...
    meta["batches"][BATCH] = {
        ...
        "model_note": (
            "syn_len4 b01 maintainer-curated blind-style pairs; "
